...
np.save('./saved_data/past_user_infomation_'+date_info+'.npy', past_user_information)
...
np.save('./saved_data/normalization_user_infomation_'+date_info+'.npy', norm_x_test)
